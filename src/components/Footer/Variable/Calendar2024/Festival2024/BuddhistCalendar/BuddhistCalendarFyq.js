...
const BuddhistCalendarFYQ = () => {
  const questions = [
    ...
    {
      id: 2,
      title: "Q-2:- Why is Vesak celebrated in Buddhism?",
      content: `Vesak commemorates the birth, enlightenment, and death of Gautama Buddha, making it a significant triple celebration.`,
    },
    {
      id: 3,
      title:
...
export default BuddhistCalendarFYQ;
