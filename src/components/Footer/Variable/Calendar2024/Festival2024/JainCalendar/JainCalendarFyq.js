...
const JainCalendarFYQ = () => {
  const questions = [
    ...
    {
      id: 2,
      title: "Q-2:- What is the significance of Paryushana Parva in Jainism?",
      content: `Paryushana Parva is a significant fasting period in Jainism, focusing on self-reflection, penance, and spiritual upliftment.`,
    },
    {
      id: 3,
      title:
...
export default JainCalendarFYQ;
