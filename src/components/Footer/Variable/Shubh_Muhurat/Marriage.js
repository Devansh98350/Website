      ...
      <StyledDiv>
        <div className="body">
          ...
          <p>
            ...
            propitious for marriages, ensuring a harmonious beginning.
          </p>
          <p>
            Muhurat, the most auspicious time for a wedding, features Abhijeet
            and Godhuli Vela as ideal moments to tie the knot, ensuring
            blessings for a lifelong journey together.
          </p>
          <p>
            The date holds significance as well. Dwitiya, Tritiya, Panchami,
            Saptami, Ekadashi Tithi, and Trayodashi Tithi are deemed auspicious
            for weddings, promising a prosperous and joyful marital life.
          </p>
          <p>
            ...
            considered favourable for weddings.
          </p>
          <p>
            Selecting the right day is vital too. Monday, Wednesday, Thursday,
            and Friday are auspicious wedding days, while Tuesday is best
            avoided for this sacred occasion.
          </p>
          <p>
