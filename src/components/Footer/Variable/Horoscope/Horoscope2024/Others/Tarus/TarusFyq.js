...
const TarusFYQ = () => {
  const questions = [
    {
      id: 1,
      title: "Q-1:- What are the key personality traits of a Taurus?",
      content: `Taureans are often associated with traits such as practicality, patience, determination, and a strong sense of loyalty. Ruled by Venus, they are known for their appreciation of beauty and their grounded nature.`,
    },
    {
      id: 2,
      title:
