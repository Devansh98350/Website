...
const CapricornFYQ = () => {
  const questions = [
    {
      id: 1,
      title: "Q-1:- What are the key personality traits of a Capricorn?",
      content: `Capricorns are often associated with traits such as discipline, ambition, practicality, and a strong sense of responsibility. Ruled by Saturn, they are known for their dedication and desire for long-term success.`,
    },
    {
      id: 2,
      title:
