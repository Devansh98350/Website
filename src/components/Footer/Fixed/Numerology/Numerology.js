        ...
        <div className="body">
          ...
          <p>
            ...
            <ul>
              <li>
                ...
                with the assistance of the numerology concept, one can figure
                out the traits of an individual and pick the appropriate
                opportunities that shall suit one all their life.
              </li>
              <br />
              <li>
                ...
                related conditions. Also, it can help in explaining what one
                must expect from the relationship.
              </li>
              <br />
              <li>
                It also explains the personality of a person. Right from their
                talents and potentials to their strengths and weaknesses; with
                the help of numerology, all this could be figured out
                effortlessly, and much more.
              </li>
              <br />
              <li>
                The Life Path Number in numerology is an ideal concept to know
                several scenarios. Thus, the challenges you may face, the ups
                and downs, along with the opportunities and challenges, people
                can figure it all out with numerology knowledge.
              </li>
            </ul>
          </p>
          ...
          <p>
            ...
            <ul className="red-text">
              <li>Tamil Numerology</li>
              <br />
              <li>Pythagorean Numerology</li>
              <br />
              <li>Pythagorean Numerology</li>
              <br />
              <li> Kabbalah Numerology</li>
            </ul>
          </p>
