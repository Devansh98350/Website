...
const Radha1000FAQ = [
  {
    id: 1,
    title: "What are the benefits of chanting Goddess Radha Shasranamavali?",
    content:
  ...
  {
    id: 2,
    title: "Which direction is ideal to chant 1000 names of Radharani?",
    content:
      "The ideal direction to chant the 1000 names of Radharani is while facing the East direction.",
  },
  {
    id: 3,
    title: "What is the 1000 names of Radha?",
    content:
...
const Radha1000 = () => {
  ...
  return (
    <Layout
      title="1000 Name of Goddess Radha - AstroSwarg"
      description=""
      keywords=""
    >
      <Breadcrumbs />
      <Container>
        <div className="body">
          ...
          <p>
            The 1000 names of Radharani are different names that are associated
            with the Goddess. These names tend to tell about the different
            qualities of Goddess Radha. Chanting these names is siad to help a
            person by removing struggles from their life. Continue reading to
            know more.
          </p>
          <h3>1000 Goddess Radha Name List</h3>
          <p>
            Below are the Radha Rani names. This list is written in alphabetical
            order for the ease of the readers. Along with the names, we have
            mentioned their associated meaning and mantra. These different names
            of Radha rani are as follows:
          </p>
          <Deity1000ButtonGrid />
          ...
          <p>
            Goddess Radha is associated with the qualities of beauty and
            limitless love in Hinduism. Her divine presence is said to enchant
            the devotees. Her blessings are considered highly crucial and
            beneficial for people who are facing difficulties in their love
            life.
          </p>
          <p>
          ...
          <p>
            Her name chanting can also benefit a person by acting as a shield
            and protecting the devotee from evil and ill energies and spirits.
            It is advised that a person should chant the names of Radharani
            during Brahma Muhurat or early morning hours. This is said to be
            highly beneficial for an individual.
          </p>
        </div>
      </Container>
      <FAQLayout faqData={Radha1000FAQ} />
    </Layout>
  );
};
