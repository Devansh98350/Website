...
const Ram1000FAQ = [
  {
    id: 1,
    title: "What is Shri Ram Sahasranam?",
    content:
  ...
  {
    id: 2,
    title: "Which are the benefits of Rama Sahasranama?",
    content:
  ...
  {
    id: 3,
    title: "What happens if we chant Rama Saharanama daily?",
    content:
  ...
  {
    id: 4,
    title: "How to chant 1000 names of Lord Rama?",
    content:
  ...
  {
    id: 5,
    title: "How to choose from 1000 names of Lord Rama for baby boy?",
    content:
  ...
  {
    id: 6,
    title: "How long does it takes to recite the entire Rama Saharsanamavali?",
    content:
...
const Ram1000 = () => {
  ...
  return (
    <Layout
      title="1000 Name of Lord Rama - AstroSwarg"
      description=""
      keywords=""
    >
      <Breadcrumbs />
      <Container>
        <div className="body">
          ...
          <p>
            Known as Rama Sahasranama, chanting the 1000 names of Shri Ram is
            believed to be very effective for human life. It offers peace,
            prosperity and improvement in your overall personality.
          </p>
          <h3>1000 Lord Rama Names</h3>
          <p>
            The 1000 names of Lord Rama are inspired by his qualities and
            various life incidents. Here is a complete list of Rama Sahasranama.
          </p>
          <Deity1000ButtonGrid />
          ...
          >
            ...
            <tbody>
              ...
              <tr>
                <td>912</td>
                <td>Sarvaga</td>
                <td>Om Sarvagaya Namah</td>
                <td>All-Pervading</td>
              </tr>
              <tr>
                <td>913</td>
                <td>Sarvabhutesha</td>
                <td>Om Sarvabhuteshaya Namah</td>
                <td>Lord of All Beings</td>
              </tr>
              <tr>
                <td>914</td>
                <td>Sarvabhutashayasthita</td>
                <td>Om Sarvabhutashayasthitaya Namah</td>
                <td>Residing in All Hearts</td>
              </tr>
              <tr>
                <td>915</td>
                <td>Abhyantarastha</td>
                <td>Om Abhyantarasthaya Namah</td>
                <td>Present Within Everything</td>
              </tr>
              <tr>
                <td>916</td>
                <td>Tamasashchettra</td>
                <td>Om Tamasashchettraya Namah</td>
              ...
              <tr>
                <td>921</td>
                <td>Prajapatipati</td>
                <td>Om Prajapatipataye Namah</td>
                <td>Lord of All Creatures</td>
              </tr>
              <tr>
                <td>922</td>
                <td>Hara</td>
              ...
              <tr>
                <td>928</td>
                <td>Jagatastasthusha</td>
                <td>Om Jagatastasthushaya Namah</td>
                <td>Stabilizer of the World</td>
              </tr>
              <tr>
                <td>929</td>
                <td>Prabhava</td>
              ...
              <tr>
                <td>932</td>
                <td>Kartri</td>
                <td>Om Kartraya Namah</td>
                <td>Doer</td>
              </tr>
              <tr>
                <td>933</td>
                <td>Dhatri</td>
                <td>Om Dhatraya Namah</td>
                <td>Sustainer</td>
              </tr>
              <tr>
                <td>934</td>
                <td>Vidhatri</td>
                <td>Om Vidhatraya Namah</td>
                <td>Supporter</td>
              </tr>
              <tr>
                <td>935</td>
                <td>Sarvesham Prabhava</td>
                <td>Om Sarvesham Prabhave Namah</td>
              ...
              <tr>
                <td>937</td>
                <td>Sahasramurti</td>
                <td>Om Sahasramurtaye Namah</td>
                <td>Thousand-Formed</td>
              </tr>
              <tr>
                <td>938</td>
                <td>Vishvatma</td>
              ...
              <tr>
                ...
                <td>Supreme Absolute Brahman</td>
              </tr>
              <tr>
                <td>953</td>
                <td>Saccidanandavigraha</td>
                <td>Om Saccidanandavigrahaya Namah</td>
                <td>Embodiment of Truth, Consciousness, and Bliss</td>
              </tr>
              <tr>
                <td>954</td>
                <td>Parasmai Jyotish</td>
              ...
              <tr>
                <td>955</td>
                <td>Parasmai Dhamne</td>
                <td>Om Parasmai Dhamne Namah</td>
                <td>Supreme Abode</td>
              </tr>
              <tr>
                <td>956</td>
                <td>Parakasha</td>
                <td>Om Parakasha Namah</td>
                <td>Supreme Sky</td>
              </tr>
              <tr>
                <td>957</td>
                <td>Paratpara</td>
                <td>Om Paratparasya Namah</td>
                <td>Beyond the Supreme</td>
              </tr>
              <tr>
                <td>958</td>
                <td>Achyuta</td>
              ...
              <tr>
                ...
                <td>Hiranyagarbha</td>
                <td>Om Hiranyagarbhaya Namah</td>
                <td>The Golden Womb</td>
              </tr>
              <tr>
                <td>971</td>
                <td>Savitre</td>
                <td>Om Savitre Namah</td>
                <td>Lord of the Sun</td>
              </tr>
              <tr>
                <td>972</td>
                <td>Lokakrit</td>
              ...
              <tr>
                <td>977</td>
                <td>Mahavishnu</td>
                <td>Om Mahavishnave Namah</td>
                <td>The Great Vishnu</td>
              </tr>
              <tr>
                <td>978</td>
                <td>Jishnu</td>
                <td>Om Jishnave Namah</td>
                <td>The Triumphant</td>
              </tr>
              <tr>
                <td>979</td>
                <td>Devahitavaha</td>
                <td>Om Devahitavahaya Namah</td>
                <td>Benefactor of the Devas</td>
              </tr>
              <tr>
                <td>980</td>
                <td>Tattvatman</td>
                <td>Om Tattvatmane Namah</td>
                <td>Embodiment of Truth</td>
              </tr>
              <tr>
                <td>981</td>
                ...
                <td>Deliverer of Souls</td>
              </tr>
              <tr>
                <td>982</td>
                <td>Brahman</td>
                <td>Om Brahmane Namah</td>
                <td>Supreme Reality</td>
              </tr>
              <tr>
                <td>983</td>
                <td>Shashvata</td>
              ...
              <tr>
                <td>984</td>
                <td>Sarvasiddhida</td>
                <td>Om Sarvasiddhidaya Namah</td>
                <td>Bestower of All Accomplishments</td>
              </tr>
              <tr>
                <td>985</td>
                <td>Akaravachya</td>
                <td>Om Akaravachya Namah</td>
                <td>Represented by the Letter 'A'</td>
              </tr>
              <tr>
                <td>986</td>
                <td>Bhagavate</td>
              ...
              <tr>
                <td>987</td>
                <td>Shri</td>
                <td>Om Shriye Namah</td>
                <td>Embodiment of Prosperity</td>
              </tr>
              <tr>
                <td>988</td>
                <td>Bhulilapataya</td>
                <td>Om Bhulilapataye Namah</td>
                <td>Lord of All Worlds</td>
              </tr>
              <tr>
                <td>989</td>
                <td>Pumsa</td>
                <td>Om Pumsa Namah</td>
                <td>The Supreme Male</td>
              </tr>
              <tr>
                <td>990</td>
                <td>Sarvalokeswara</td>
                <td>Om Sarvalokeswaraya Namah</td>
                <td>Lord of All Worlds</td>
              </tr>
              <tr>
                <td>991</td>
              ...
              <tr>
                <td>993</td>
                <td>Sarvatomukha</td>
                <td>Om Sarvatomukhaya Namah</td>
                <td>Facing All Directions</td>
              </tr>
              <tr>
                <td>994</td>
                <td>Swami</td>
                <td>Om Swamine Namah</td>
                <td>Lord and Master</td>
              </tr>
              <tr>
                <td>995</td>
                <td>Sushila</td>
                <td>Om Sushilaya Namah</td>
                <td>Gentle and Virtuous</td>
              </tr>
              <tr>
                <td>996</td>
                <td>Sulabha</td>
              ...
              <tr>
                <td>997</td>
                <td>Sarvashaktimat</td>
                <td>Om Sarvashaktimate Namah</td>
                <td>Omnipotent</td>
              </tr>
              <tr>
                <td>998</td>
          ...
          <p>
            Lord Rama is an incarnation of Lord Vishnu where “<b>Ra</b>”, “
            <b>Ma</b>”, and “<b>A</b>” signify <b>the Sun</b>, <b>the Moon</b>{" "}
            and <b>Fire</b>, indicating calling the supreme light of God. Just
            imagine what power calling Lord Rama other names must hold. Pandits
            advise chanting his names, especially during <b>RamNavami Puja</b>,
            for peace and prosperity.
          </p>
          <p>
            Moreover, it is a perfect way for devotees to express their love and
            devotion towards the supreme Lord Rama. Chanting 1000 names of Lord
            Rama, one can attract his qualities in one’s own personality. It not
            only promotes spiritual growth but is a symbol of long-term
            protection against negative energies.
          </p>
        </div>
      </Container>
      <FAQLayout faqData={Ram1000FAQ} />
    </Layout>
  );
};
